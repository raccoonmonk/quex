...
class ComparisonSequence(object):
    ...
    def optimize(tm):
        ...
        def detect_a(tm, Index):
            ...
            """
            previous = None
            for target in (tm[i][1] for i in range(Index, len(tm), 2)):
        ...
        def detect_b(tm, Index):
            ...
            """
            for interval in (tm[i][0] for i in range(Index, len(tm), 2)):
