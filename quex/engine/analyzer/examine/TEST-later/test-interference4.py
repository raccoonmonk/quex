...
# are important.
examiner.mouth_db[1] = get_MouthStateInfoIpOffset(entry_n, scheme_0, False)
examiner.mouth_db[2] = get_MouthStateInfoIpOffset(entry_n, scheme_1, False)
examiner.mouth_db[3] = get_MouthStateInfoIpOffset(entry_n, scheme_2, False)
examiner.mouth_db[4] = get_MouthStateInfoIpOffset(entry_n, scheme_3, False)
