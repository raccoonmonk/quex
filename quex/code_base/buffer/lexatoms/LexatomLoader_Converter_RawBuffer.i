...
#ifndef  QUEX_INCLUDE_GUARD__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_RAW_BUFFER_I
#define  QUEX_INCLUDE_GUARD__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_RAW_BUFFER_I
 ...
 * remains unaffected. The pointer still points to the same character index. */
{
    ...
    if( ! move_distance ) {
        ...
        QUEX_GSTD(memmove)((void*)me->begin, (void*)move_begin_p, (size_t)move_size);
    }
...
#endif /*  QUEX_INCLUDE_GUARD__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_RAW_BUFFER_I */
